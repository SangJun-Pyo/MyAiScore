...
const ko = {
  ...
  shell: {
    ...
    home: "홈", profile: "내 리포트", insights: "해석 가이드", leaderboard: "리더보드", evaluate: "저장소 분석", github: "GitHub",
  ...
  report: {
    ...
    gapsEyebrow: "미확인 신호", gapsHeading: "확인하지 못한 신호도 함께 보여드려요.", noGaps: "이번 규칙으로 확인한 범위에서는 놓친 신호가 없었어요.",
  ...
  leaderboard: {
    title: "리더보드", description: "사용자가 공개하기로 선택한 결과만 모아, 서버가 재검증한 점수 순으로 보여줘요.", cta: "내 저장소 분석하기 →",
...
const en: Messages = {
  ...
  shell: { skip: "Skip to content", brandHome: "MyAiScore home", beta: "DEMO", navLabel: "Main navigation", home: "Home", profile: "Reports", insights: "Guide", leaderboard: "Leaderboard", evaluate: "Analyze", github: "GitHub", footerLead: "Explore traces of AI collaboration in a public repository.", footerLimit: "Not a certification of personal AI ability." },
  report: {
  ...
  leaderboard: {
    title: "Leaderboard", description: "Only results users chose to publish, ranked by server-re-verified score.", cta: "Analyze my repository →",
