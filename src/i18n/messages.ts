...
const ko = {
  ...
  report: {
    ...
    nextChallenge: "다음 단계", recommendations: "효율이 높은 다음 작업", recommendationsIntro: "점수 상승 여지와 예상 작업량을 함께 계산해 우선순위를 정했습니다. 계산 계수는 화면에 표시하지 않습니다.", saveIntro: "저장은 선택 사항입니다. 원문이나 GitHub 계정 정보 없이 이 요약만 현재 브라우저에 저장됩니다.",
