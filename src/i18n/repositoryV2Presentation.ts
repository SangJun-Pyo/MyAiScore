...
const koActions: Record<RepositoryReportScoreSignalId, { title: string; description: string }> = {
  ...
  "traceability-templates": { title: "이슈·PR 기록 틀 만들기", description: "문제, 변경 이유, 검증 결과를 빠뜨리지 않도록 템플릿을 추가해 보세요." },
...
const ko = {
  ...
  recommendationEffort: { quick: "가볍게", medium: "보통 작업", large: "큰 작업" } satisfies Record<RepositoryRecommendationEffort, string>,
