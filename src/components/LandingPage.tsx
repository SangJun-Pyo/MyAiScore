...
export default function LandingPage({ onExample, children }: { onExample: () => void; children: React.ReactNode }) {
  ...
  return <div className="landing-editorial" data-testid="english-landing">
    ...
    <section id="process" className="landing-section landing-process">
      ...
      <div className="landing-section-intro"><h2>A project.<br />A conversation.<br />A way forward.</h2><p>Start with the work you already have.<br />Add the context only you can provide.</p></div>
    ...
    <section id="example" className="landing-section landing-example">
      ...
      <div className="landing-section-intro"><h2>A number is a start.<br /><em>The next move is yours.</em></h2><p>Explore the report format with a synthetic example.<br />It is not a real user's result or a measure of model accuracy.</p></div>
      {children}
