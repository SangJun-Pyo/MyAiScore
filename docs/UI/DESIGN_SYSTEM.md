...
- **Guide:** show all v2.3 signal values in a horizontally scrollable semantic table. For v2.2+ show the four collaboration-profile dimensions, relative strengths, boundary state and explicit withheld reasons; for historical v1/v2.1 keep the six style rules and tie priority.
